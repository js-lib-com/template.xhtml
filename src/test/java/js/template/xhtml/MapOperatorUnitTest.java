...
public class MapOperatorUnitTest extends TestCaseEx {
	...
	public void testMapOfPrimitives() throws IOException {
		String html = "" + //
				"<dl data-map='map'>" + //
				"   <dt data-text='.'></dt>" + //
				"   <dd data-text='.'></dd>" + //
	...
	public void testMapOfDefaultPrimitives() throws IOException {
		String html = "" + //
				"<dl data-map='map'>" + //
				"   <dt></dt>" + //
				"   <dd></dd>" + //
	...
	public void testMapOfDefaultObjects() {
		String html = "" + //
				"<dl data-map='map'>" + //
				"   <dt></dt>" + //
				"   <dd>" + //
	...
	public void testBadMapValueTypes() {
